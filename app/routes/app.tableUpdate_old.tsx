...
const ProfitDetails = () => {
  ...
  const filteredRows = rows.filter((row) =>
    row.refundNotes.toLowerCase().includes(searchTerm.toLowerCase()),
  );
  ...
  const RefundTable = ({ refunds }) => {
    ...
    const filteredRefunds = refunds.filter((refund) =>
      refund.refundNotes.toLowerCase().includes(refundSearchTerm.toLowerCase()),
    );
